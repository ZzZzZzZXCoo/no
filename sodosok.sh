...
cd /usr/bin
wget -q -O add-ss "https://raw.githubusercontent.com/ZzZzZzZXCoo/no/main/add-ss.sh"
wget -q -O del-ss "https://raw.githubusercontent.com/ZzZzZzZXCoo/no/main/del-ss.sh"
wget -q -O cek-ss "https://raw.githubusercontent.com/ZzZzZzZXCoo/no/main/cek-ss.sh"
wget -q -O renew-ss "https://raw.githubusercontent.com/ZzZzZzZXCoo/no/main/renew-ss.sh"
chmod +x add-ss
chmod +x del-ss
chmod +x cek-ss
chmod +x renew-ss
