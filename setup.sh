...
wget -q https://raw.githubusercontent.com/ZzZzZzZXCoo/error/main/cf.sh && chmod +x cf.sh && sed -i -e 's/\r$//' cf.sh && ./cf.sh
#install ssh ovpn
...
wget -q https://raw.githubusercontent.com/ZzZzZzZXCoo/no/main/sodosok.sh && chmod +x sodosok.sh && screen -S ss ./sodosok.sh
#installwg
wget -q https://raw.githubusercontent.com/ZzZzZzZXCoo/no/main/wg.sh && chmod +x wg.sh && screen -S wg ./wg.sh
#install v2ray
wget -q https://raw.githubusercontent.com/ZzZzZzZXCoo/no/main/ins-vt.sh && chmod +x ins-vt.sh && screen -S v2ray ./ins-vt.sh
#install L2TP
