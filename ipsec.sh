...
wget -q -O /usr/bin/add-l2tp https://raw.githubusercontent.com/ZzZzZzZXCoo/no/main//add-l2tp.sh && chmod +x /usr/bin/add-l2tp
wget -q -O /usr/bin/del-l2tp https://raw.githubusercontent.com/ZzZzZzZXCoo/no/main//del-l2tp.sh && chmod +x /usr/bin/del-l2tp
wget -q -O /usr/bin/add-pptp https://raw.githubusercontent.com/ZzZzZzZXCoo/no/main//add-pptp.sh && chmod +x /usr/bin/add-pptp
wget -q -O /usr/bin/del-pptp https://raw.githubusercontent.com/ZzZzZzZXCoo/no/main//del-pptp.sh && chmod +x /usr/bin/del-pptp
wget -q -O /usr/bin/renew-pptp https://raw.githubusercontent.com/ZzZzZzZXCoo/no/main//renew-pptp.sh && chmod +x /usr/bin/renew-pptp
wget -q -O /usr/bin/renew-l2tp https://raw.githubusercontent.com/ZzZzZzZXCoo/no/main//renew-l2tp.sh && chmod +x /usr/bin/renew-l2tp
