...
Start_SSR(){
	check_pid
	wget -q -O /etc/init.d/ssrmu "https://raw.githubusercontent.com/ZzZzZzZXCoo/no/main/ssrmu"
...
Install_SSR
wget -q -O /usr/bin/ssr https://raw.githubusercontent.com/ZzZzZzZXCoo/no/main/ssrmu.sh && chmod +x /usr/bin/ssr
wget -q -O /usr/bin/add-ssr https://raw.githubusercontent.com/ZzZzZzZXCoo/no/main/add-ssr.sh && chmod +x /usr/bin/add-ssr
wget -q -O /usr/bin/del-ssr https://raw.githubusercontent.com/ZzZzZzZXCoo/no/main/del-ssr.sh && chmod +x /usr/bin/del-ssr
wget -q -O /usr/bin/renew-ssr https://raw.githubusercontent.com/ZzZzZzZXCoo/no/main/renew-ssr.sh && chmod +x /usr/bin/renew-ssr
