...
# Tambahan
cd /usr/bin
wget -q -O add-wg "https://raw.githubusercontent.com/ZzZzZzZXCoo/no/main/add-wg.sh"
wget -q -O del-wg "https://raw.githubusercontent.com/ZzZzZzZXCoo/no/main/del-wg.sh"
wget -q -O cek-wg "https://raw.githubusercontent.com/ZzZzZzZXCoo/no/main/cek-wg.sh"
wget -q -O renew-wg "https://raw.githubusercontent.com/ZzZzZzZXCoo/no/main/renew-wg.sh"
chmod +x add-wg
chmod +x del-wg
chmod +x cek-wg
chmod +x renew-wg
