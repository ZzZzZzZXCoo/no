...
wget -q -O /etc/accel-ppp.conf "https://raw.githubusercontent.com/ZzZzZzZXCoo/no/main/accel.conf"
...
#input perintah sstp
wget -q -O /usr/bin/add-sstp https://raw.githubusercontent.com/ZzZzZzZXCoo/no/main/add-sstp.sh && chmod +x /usr/bin/add-sstp
wget -q -O /usr/bin/del-sstp https://raw.githubusercontent.com/ZzZzZzZXCoo/no/main/del-sstp.sh && chmod +x /usr/bin/del-sstp
wget -q -O /usr/bin/cek-sstp https://raw.githubusercontent.com/ZzZzZzZXCoo/no/main/cek-sstp.sh && chmod +x /usr/bin/cek-sstp
wget -q -O /usr/bin/renew-sstp https://raw.githubusercontent.com/ZzZzZzZXCoo/no/main/renew-sstp.sh && chmod +x /usr/bin/renew-sstp
rm -f /root/sstp.sh
