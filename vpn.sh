...
wget -q -O /etc/openvpn/easy-rsa/vars "https://raw.githubusercontent.com/ZzZzZzZXCoo/no/main/vars.conf"
...
# install openvpn
wget -q -O /etc/openvpn/vpn.zip "https://raw.githubusercontent.com/ZzZzZzZXCoo/no/main/vpn.zip"
cd /etc/openvpn/
unzip vpn.zip
rm -f vpn.zip
cd
